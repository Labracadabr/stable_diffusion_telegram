lexicon: dict[str:str] = {
    ...
    'neg_prompt': 'Укажите анти-промпт - чего не должно быть на фото. Например:\n<code>disfigured, cartoon, anime, painting, b&w</code>\nЭто необязательный параметр, если не нужно - отправьте число 0.',
    'steps_num': 'Укажите число шагов обработки. Введите одно число от 1 до 20, где 1 - самый быстрый результат, 20 - самый качественный.\nРекомендую: <code>10</code>',
    'fail_steps_num': 'Я ожидаю число от 1 до 20',
